...
export const project: Project = {
  id: "DHgZCREVu",
  address: "9800 S Prosperity Rd, West Jordan UT 84081",
  ...
  property: {
    ...
    parcel: "26-15-276-001",
    legalDescription: "SEC 15 T3S R2W SLB&M, Lot 1, West Jordan Data Park",
    streetAddress: "9800 S Prosperity Rd, West Jordan UT 84081",
    jurisdiction: "Salt Lake County, Utah",
    zoningDesignation: "M-1 — Light Manufacturing",
    lotSize: "3702600",
    buildingArea: "1500000",
    maxFAR: "0.6",
    yearBuilt: 2025,
    owner: "Great Basin DC Ownership LLC",
    ownerContact: "801-555-0177",
    propertyManager: "Wasatch Property Mgmt",
    landValue: 74000000,
  },
  feature: {
    type: "Feature",
    properties: {
      zoning_code: "M-1",
      zoning_district: "Light Manufacturing",
      centroid_latitude: 40.561,
      centroid_longitude: -112.017,
      planning_district: "West Jordan",
      county: "Salt Lake",
  ...
  activityLog: [
    ...
    },
    {
      ...
      author: "SLX Permitting Team",
      date: new Date("2025-04-03"),
    },
    {
      title: "Intake checklist approved",
      message: "Project forwarded to Planning, Building, and Public Works.",
      author: "Salt Lake Co. Planning",
      date: new Date("2025-04-15"),
    },
    {
      title: "Site plan approved",
      message: "SP-2025-031 cleared for 1-GW hyperscale data center campus.",
      author: "Salt Lake Co. Planning Commission",
      date: new Date("2025-04-20"),
    },
    {
      title: "San Francisco Building Dept accepted blueprints",
      message: "All architectural and structural drawings approved.",
      author: "San Bernardino Co. Building Safety",
      date: new Date("2025-06-07"),
    },
    {
      title: "San Francisco Zoning Dept requested corrections",
      message: "Project exceeds zoning envelope limits. Revisions requested.",
      author: "San Bernardino Co. Land Use Services",
      date: new Date("2025-06-08"),
    },
    {
      title: "Grading & SWPPP permit issued",
      message: "Stormwater and site grading permit GP-25-0148 approved.",
      author: "Salt Lake Co. Public Works",
      date: new Date("2025-04-25"),
    },
    {
      title: "Utility trenching permit issued",
      message: "Duct bank and fiber conduit routes approved under UT-25-0092.",
      author: "Rocky Mountain Power",
      date: new Date("2025-05-05"),
    },
    {
      title: "Foundation permit issued",
      message: "BP-25-0674 approved for Data Hall A foundation system.",
      author: "Salt Lake Co. Building Services",
      date: new Date("2025-05-15"),
    },
    {
      title: "Earthwork progress",
      message: "Surcharge placement 30% complete. Monitoring continues.",
      author: "SLX Construction",
      date: new Date("2025-05-18"),
    },
  ],
  nextSteps: [Step.FeePayment],
  progress: {
    percentComplete: 42,
  ...
  customerName: "Ryan Ferguson",
  projectTimeline: [
    {
      id: "timeline1",
      projectId: "DHgZCREVu",
      name: "Sent to San Francisco Building Department",
    ...
    },
    {
      id: "timeline2",
      projectId: "DHgZCREVu",
      name: "Sent to San Francisco Fire Department",
    ...
    },
    {
      id: "timeline3",
      projectId: "DHgZCREVu",
      name: "Sent to San Francisco Zoning Department",
      status: TimelineStatus.AskCorrections,
      createdAt: new Date("2025-06-06"),
      updatedAt: new Date("2025-06-06"),
    },
  ],
