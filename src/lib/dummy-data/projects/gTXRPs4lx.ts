...
export const project: Project = {
  id: "gTXRPs4lx",
  address: "21450 Pacific Blvd, Sterling VA 20166",
  ...
  property: {
    ...
    parcel: "045288382000",
    legalDescription: "Tax Map 045-28-8382, Section 33 T2N R5W",
    streetAddress: "21450 Pacific Blvd, Sterling VA 20166",
    jurisdiction: "Loudoun County, Virginia",
    zoningDesignation: "PD-IP — Planned Development–Industrial Park",
    lotSize: "958320",
    buildingArea: "600000",
    maxFAR: "0.4",
    yearBuilt: 2023,
    owner: "Digital Ashburn II LLC",
    ownerContact: "703-555-0110",
    propertyManager: "EdgeCore Property Mgmt",
    landValue: 85000000,
  },
  feature: {
    type: "Feature",
    properties: {
      zoning_code: "PD-IP",
      centroid_latitude: 39.02085,
      centroid_longitude: -77.467,
      zoning_district: "Planned Development–Industrial Park",
      planning_district: "Broad Run",
      county: "Loudoun",
  ...
  activityLog: [
    {
      ...
      author: "Loudoun Co. Planning",
      date: new Date("2025-02-10"),
    },
    {
      title: "Application submitted",
      message: "The intake form and required documents were submitted.",
      author: "Loudoun Co. Planning",
    ...
    },
    {
      ...
      message:
        "Rescope finished reviewing the application and requested 9 missing items.",
      author: "System",
