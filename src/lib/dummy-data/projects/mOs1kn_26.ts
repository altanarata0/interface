...
export const newRegulations: Regulation[] = [
  {
    id: "1",
    code: {
      jurisdiction: "San Francisco",
...
export const getNewProject = ({
  ...
  lastUpdate: new Date(),
  ballInCourt: "User", // Default value
  property: {
    geojson: {},
    parcel: "N/A",
    legalDescription: "N/A",
    streetAddress: newProjectAddress,
    jurisdiction: city || "N/A",
    zoningDesignation: "N/A",
    lotSize: "N/A",
    buildingArea: "N/A",
    maxFAR: "N/A",
  ...
  feature: null, // Default value
  activityLog: [
    {
      title: "Project Created",
      message: `Project created for address: ${newProjectAddress}`,
      author: "System",
      date: new Date(),
    },
  ],
  progress: {
    ...
    completionDate: new Date(new Date().setDate(new Date().getDate() + 30)), // Estimated 30 days
    daysElapsed: 0,
  },
  nextSteps: [Step.UploadFiles], // Initial next step
  files: [
    {
      id: "1",
