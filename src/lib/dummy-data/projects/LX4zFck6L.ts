...
export const project: Project = {
  id: "LX4zFck6L",
  address: "4500 N Cotton Ln, Goodyear AZ 85395",
  status: ProjectStatus.OnTrack,
  lastUpdate: new Date("2025-05-17"),
  ...
  property: {
    ...
    parcel: "502-54-010G",
    legalDescription: "Lot 2, Cotton Lane Commerce Park, Section 30 T2N R1W",
    streetAddress: "4500 N Cotton Ln, Goodyear AZ 85395",
    jurisdiction: "Maricopa County, Arizona",
    zoningDesignation: "I-2 — Heavy Industrial",
    lotSize: "5227200",
    buildingArea: "1200000",
    maxFAR: "0.5",
    yearBuilt: 2024,
    owner: "West Valley Data Hub, LLC",
    ownerContact: "602-555-0199",
    propertyManager: "Red River Property Mgmt",
    landValue: 68000000,
  },
  feature: {
    type: "Feature",
    properties: {
      zoning_code: "I-2",
      centroid_latitude: 33.464,
      centroid_longitude: -112.3855,
      zoning_district: "Heavy Industrial",
      planning_district: "West Valley",
      county: "Maricopa",
  ...
  activityLog: [
    {
      title: "Applicant created a new project",
      message: "",
      author: "GLX Construction",
      date: new Date("2025-06-05"),
    },
  ],
  nextSteps: [Step.FillMissingItems, Step.ReviewViolations],
  progress: {
    percentComplete: 0,
  ...
  files: [
    {
      ...
      url: "/blueprint-center.pdf",
      status: "In-Review",
      regulations,
    },
  ],
  customerName: "Clark Construction Group",
  projectTimeline: [
    {
      id: "timeline1",
      projectId: "LX4zFck6L",
